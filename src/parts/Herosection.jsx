...
const HeroSlider = ({ slides }) => {
  ...
  return (
    <div
      className="relative md:mr-20 main h-[500px] overflow-hidden mt-5"
    ...
    >
      {slides.map((slide, index) => (
        ...
        >
          ...
          <div
            className={`container mx-auto px-4 text-center z-20 transition-opacity duration-300 ${
      ...
      <button
        className="absolute top-1/2 left-0 ml-1 transform -translate-y-1/2 text-white bg-black bg-opacity-35 p-2 rounded-full"
      ...
      <button
        className="absolute top-1/2 right-12 transform -translate-y-1/2 text-white bg-black bg-opacity-35 p-2 rounded-full"
