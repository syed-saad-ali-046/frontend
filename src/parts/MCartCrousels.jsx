            ...
            <div key={productdata.id}>
              <div className="mobilecontainer bg-white p-4 rounded-lg shadow-md hover:scale-105 transition-transform duration-300 mb-8">
                ...
                <div className="pt-4 bg-gray-100 rounded-md">
                  ...
                  <button onClick={() => dispatch(addtoCart({ id: productdata.id, image: productdata.image , name: productdata.name, price: productdata.price,colors: productdata.colors}))}  type="button" className="bet text-white gap-2 bg-[#050708] hover:bg-[#050708]/80 focus:ring-4 focus:outline-none focus:ring-[#050708]/50 font-medium rounded-lg text-sm px-3.5 ml-11 mt-2 py-2 text-center inline-flex items-center dark:hover:bg-[#050708]/40 dark:focus:ring-gray-600 me-2 mb-3">
          ...
          {productData.map((productdata) => (
            <div key={productdata.id} className="bg-white p-4 w-64 rounded-lg shadow-md hover:scale-105 transition-transform duration-300 mb-8">
              ...
              <div className="pt-4 bg-gray-100 rounded-md">
                ...
                <button onClick={() => dispatch(addtoCart({id: productdata.id, image: productdata.image , name: productdata.name, price: productdata.price,colors: productdata.colors }))}  type="button"  className="text-white gap-2 bg-[#050708] hover:bg-[#050708]/80 focus:ring-4 focus:outline-none focus:ring-[#050708]/50 font-medium rounded-lg text-sm px-3.5 ml-11 mt-2 py-2 text-center inline-flex items-center bet dark:hover:bg-[#050708]/40 dark:focus:ring-gray-600 me-2 mb-3">
                  <svg xmlns="http://www.w3.org/2000/svg" fill="none" viewBox="0 0 24 24" stroke-width="1.5" stroke="currentColor" className="w-5 h-5">
                    <path strokeLinecap="round" strokeLinejoin="round" d="M2.25 3h1.386c.51 0 .955.343 1.087.835l.383 1.437M7.5 14.25a3 3 0 0 0-3 3h15.75m-12.75-3h11.218c1.121-2.3 2.1-4.684 2.924-7.138a60.114 60.114 0 0 0-16.536-1.84M7.5 14.25 5.106 5.272M6 20.25a.75.75 0 1 1-1.5 0 .75.75 0 0 1 1.5 0Zm12.75 0a.75.75 0 1 1-1.5 0 .75.75 0 0 1 1.5 0Z" />
                  </svg>
                  Add to Cart
